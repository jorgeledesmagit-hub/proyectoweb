...
$result = $db->query("SELECT COUNT(*) as total FROM pedidos WHERE estado = 'procesando'");
$stats['procesando'] = $result->fetch_assoc()['total'];

$result = $db->query("SELECT COUNT(*) as total FROM pedidos WHERE estado = 'enviado'");
$stats['enviados'] = $result->fetch_assoc()['total'];

$result = $db->query("SELECT COUNT(*) as total FROM pedidos WHERE estado = 'entregado'");
$stats['entregados'] = $result->fetch_assoc()['total'];

$result = $db->query("SELECT SUM(total) as total FROM pedidos WHERE estado = 'entregado'");
