...
if (!isset($_SESSION['is_admin']) || !$_SESSION['is_admin']) {
    header('Location: /proyectoweb/index.php?error=acceso_denegado');
    exit;
}
...
try {
    ...
    if ($result->num_rows === 0) {
        ...
        session_destroy();
        header('Location: /proyectoweb/login.php?error=privilegios_revocados');
        exit;
    }
    ...
    header('Location: /proyectoweb/login.php?error=error_sistema');
    exit;
}
