...
if (!isset($_SESSION['user_id'])) {
    header('Location: /proyectoweb/login.php?error=no_autenticado');
    exit;
}
...
if (!$usuario) {
    header('Location: /proyectoweb/logout.php');
    exit;
}
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            ...
                            <?php if ($usuario['is_admin']): ?>
                                <a href="/proyectoweb/admin/index.php" class="btn btn-outline-success">
                                    <i class="fas fa-tachometer-alt me-2"></i>Panel de Administración
                                </a>
                            <?php endif; ?>
                            <a href="/proyectoweb/index.php" class="btn btn-outline-secondary">
                                <i class="fas fa-home me-2"></i>Ir a la Tienda
                            </a>
                            <a href="/proyectoweb/logout.php" class="btn btn-outline-danger">
